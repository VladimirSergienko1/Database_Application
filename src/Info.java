...
class Info {
    ...
    private String Fio,Date_out, Package_type,Package_status,Country_out,Country_in,Fio_out,Fio_in,Post_num,Post_index,adres_in;
    
    public Info (String Fio, int package_n, int Weight,String Package_type,String Package_status,String Country_out,String Country_in,String Fio_out,String Fio_in,String Post_num,String Post_index,String adres_in,String Date_out ){
